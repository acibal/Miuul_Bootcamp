...
user_movie_count[user_movie_count["movie_count"] == 33].count() # tüm filmleri izleyen random_user gibi kaç user var
...
top_users_ratings['weighted_rating'] = top_users_ratings['corr'] * top_users_ratings['rating'] ### ** burda scale yapmadık. yapabilirdik ** ###
