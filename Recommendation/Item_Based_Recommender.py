...
# 1000'den az reting almış filmleri indirgedik. İstenirse az rating veren kullanıcılar da indirgenebilir.
...
check_film("Insomnia", user_movie_df) # letter sensitive
