...
# ayrı ayrı da zaman serisi değil gibi de yapılabilir.
...
# early_stopping_rounds artık çalışmıyor çünkü işlenmiş parametre olarak girmeye gerek yok. Otomatik yapıyor zaten.
