...
cart_model = DecisionTreeClassifier(random_state=17).fit(X, y) # .fit(X, y) gerek yok CV yapacaksak
...
cart_best_grid.predict(random) # CV de aslında bir model
...
# Öncesinde en iyi hiperparametre kombinasyonunu bulmuştuk. Burada sadece tek tek hiperparametrelere bakıyoruz.
