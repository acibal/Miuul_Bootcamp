...
new_model = joblib.load("ml_docs./voting_clf.pkl")

# new_model.predict(random_user) # hata alınacak yeni veri ile load ettiğimiz veri setini düzenlenmiş versiyonu

# from diabetes_pipeline import diabetes_data_prep
# from çalışmadığından fonksiyonları getirdim.
