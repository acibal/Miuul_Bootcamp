...
df_control = pd.read_excel("case_studies/measurement/ABTesti/ab_testing.xlsx", sheet_name="Control Group")
df_test = pd.read_excel("case_studies/measurement/ABTesti/ab_testing.xlsx", sheet_name="Test Group")
df_control.head()
df_test.head()
