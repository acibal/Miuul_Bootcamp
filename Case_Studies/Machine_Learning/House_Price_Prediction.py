...
train = pd.read_csv("case_studies/machine_learning/Case_Study_4/Paylaşılan/train.csv")
test = pd.read_csv("case_studies/machine_learning/Case_Study_4/Paylaşılan/test.csv")
len(train)
len(test)
