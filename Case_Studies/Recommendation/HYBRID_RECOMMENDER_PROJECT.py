...
movie = pd.read_csv('case_studies/recommendation/HybridRecommender-221114-235254/datasets/movie.csv')
rating = pd.read_csv('case_studies/recommendation/HybridRecommender-221114-235254/datasets/rating.csv')
