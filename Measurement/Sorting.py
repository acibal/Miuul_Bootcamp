...
df.loc[df["course_name"].str.contains("Veri Bilimi")].sort_values("weighted_sorting_score", ascending=False).head(20)
...
df = pd.read_csv("Miuul/DS_Bootcamp_13/datasets/movies_metadata.csv",
...
df.loc[df["vote_count"] > 400].sort_values("vote_average", ascending=False).head(20)
...
df = pd.read_csv("Miuul/DS_Bootcamp_13/datasets/imdb_ratings.csv")
df = df.iloc[0:, 1:]
